...
const DataverseHub: React.FC = () => {
  ...
  return (
    <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <SectionHeader
                ...
                subtext="We build and deploy AI platforms for governments, telecoms and enterprises. Datalake architecture, agentic AI frameworks, ML pipelines â€” delivered end to end."
              />
      ...
      <div className="bg-bg-secondary py-10 md:py-12 border-y border-border-subtle overflow-hidden">
        <div className="container mx-auto px-[60px]">
          <div className="flex flex-col md:flex-row md:justify-center items-center gap-6 md:gap-12 text-[10px] md:text-xs font-semibold text-text-tertiary uppercase tracking-[0.15em] text-center">
            <span>Deployed for NITB â€” Government of Pakistan</span>
        ...
        <div className="container mx-auto px-[60px]">
          ...
          <div className="space-y-16 md:space-y-32">
            ...
            <div id="syncro">
              <DataverseLargeProduct 
                title="Syncro"
                body="Agentic AI product for enterprise automation. Syncro deploys as a configurable agent layer on top of your existing systems â€” connecting data sources and triggering workflows."
      ...
      <section className="container mx-auto px-[60px] mb-20 lg:mb-32">
        <div className="bg-[#111113] border border-[#27272A] rounded-2xl p-8 md:p-12 lg:p-16">
          <div className="flex flex-col lg:flex-row items-center lg:items-start gap-10">
            ...
            <div className="flex-grow text-center lg:text-left">
              <h3 className="text-[18px] md:text-xl font-medium text-text-primary mb-3">Microsoft Partner â€” Data & AI</h3>
              <p className="text-text-secondary text-[14px] md:text-[15px] leading-relaxed mb-6 max-w-2xl mx-auto lg:mx-0">
                Our Dataverse platform is built on Microsoft Azure infrastructure and certified as a Microsoft Data & AI solutions partner â€” bringing enterprise-grade cloud reliability, security and AI tooling to every deployment.
              </p>
      ...
      <section className="container mx-auto px-[60px] py-20">
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
             <div className="order-2 lg:order-1">
               ...
               <p className="text-text-primary text-lg md:text-xl font-medium mb-6 md:mb-8 leading-relaxed">
                 "Deployed a national-scale agentic AI platform and datalake for NITB â€” the National Information Technology Board of Pakistan. Built to serve government-grade data requirements at national scale."
               </p>
...
const DataverseLargeProduct = ({ eyebrow, title, body, features, visual, accent, reversed = false }: any) => (
  <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center ${reversed ? 'lg:flex-row-reverse' : ''}`}>
    <div className={reversed ? 'lg:order-2' : ''}>
      ...
      <Link to="/contact" className="btn-secondary w-full sm:w-auto text-center">Talk to our enterprise team â†’</Link>
    </div>
