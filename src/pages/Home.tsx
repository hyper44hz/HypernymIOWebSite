...
const Home: React.FC = () => {
  return (
    <div className="overflow-x-hidden">
      {/* Section 1 â€” Hero */}
      <section className="relative h-[100vh] min-h-[600px] md:min-h-[800px] flex items-center justify-center bg-[#220b2d] overflow-hidden">
        ...
        <div className="container mx-auto px-[60px] relative z-10 py-20 lg:py-0 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left Column â€” Text */}
          <div className="-mt-[110px]">
            ...
            <motion.div
              ...
              className="flex flex-col sm:flex-row items-start gap-4 mb-24 lg:mb-0"
            >
        ...
        <div className="absolute bottom-0 left-0 w-full bg-bg-secondary border-t border-border-subtle py-6 md:py-10">
          <div className="container mx-auto px-[60px] grid grid-cols-2 md:flex md:flex-row md:justify-around items-center gap-8 md:gap-4">
      ...
      {/* Section 3 â€” Two Pillars */}
      <section className="bg-bg-primary section-padding container mx-auto px-[60px]">
        <SectionHeader 
      ...
      <section className="bg-bg-secondary section-padding">
        <div className="container mx-auto px-[60px]">
          <SectionHeader 
            ...
            subtext="Modular by design. Unified by default. Add the products you need â€” they all speak to each other."
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-[800px] mx-auto">
            <ProductCard 
              ...
              title="Sustainex"
              body="ESG and sustainability intelligence. Works as a layer on any IoTility product â€” or standalone via data ingestion from existing systems."
      ...
      {/* Section 5 â€” Dataverse Feature */}
      <section className="bg-bg-primary section-padding">
        <div className="container mx-auto px-[60px] grid md:grid-cols-2 gap-16 md:gap-20 items-center">
          <div>
            <SectionHeader 
              eyebrow="DATAVERSE"
              h2="Enterprise AI. Deployed, not promised."
              subtext="We don't sell AI strategy. We build and deploy AI infrastructure â€” datalakes, ML frameworks and agentic AI platforms â€” for governments and telecoms."
            />
        ...
        <div className="container mx-auto px-[60px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-16">
            ...
            <CaseStudyCard 
              ...
              body="Deployed IoTility across Qatar Energy, Bateel, and First Group through Vodafone Qatar â€” unifying fleet and asset intelligence."
      ...
      {/* Section 7 â€” Hardware & Technology Partners */}
      <section className="bg-bg-primary section-padding border-y border-border-subtle">
        <div className="container mx-auto px-[60px] text-center">
