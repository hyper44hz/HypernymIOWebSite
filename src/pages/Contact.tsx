        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          <div>
            ...
            <p className="text-text-secondary text-[16px] md:text-lg lg:text-[18px] leading-relaxed mb-12">
              Whether you're evaluating IoTility for your fleet, exploring Dataverse for an enterprise AI project, or just want to understand what's possible — we're here.
            </p>
            ...
            <div className="flex gap-4 mb-12">
               ...
               <LinkIcon icon={<span className="text-xl font-bold">𝕏</span>} />
            </div>
