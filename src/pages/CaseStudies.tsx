      ...
      <section className="section-padding bg-bg-primary">
        <div className="container mx-auto px-[60px]">
          ...
          <SectionHeader 
            ...
            subtext="From 100-vehicle fleets in Nigeria to national AI platforms for government â€” here is what we have built and what it delivered."
          />
          ...
          <div className="space-y-24 md:space-y-32">
            ...
            <CaseStudyFull 
              ...
              body="Through our partnership with MTN Nigeria, we deployed Fleet Intelligence across over 100 SME customers â€” bringing real-time vehicle tracking, driver safety and fuel monitoring."
              results={[
            ...
            <CaseStudyFull 
              ...
              body="Built and deployed a national-scale agentic AI platform and datalake architecture for NITB."
              results={[
                "National-scale datalake",
                "Agentic AI orchestration",
                "Secure government-grade infra"
              ]}
...
const CaseStudyFull = ({ logo, title, body, results, tags, image }: any) => (
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
    ...
    {/* âœ… DIFFERENT IMAGE PER SECTION */}
