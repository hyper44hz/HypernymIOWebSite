      ...
      <section className="section-padding bg-bg-primary">
        <div className="container mx-auto px-6">
          <SectionHeader 
            ...
            subtext="Fleet intelligence, asset tracking, digital twin and sustainability — all under one login. Start with one product. Add more as you grow."
          />
          <div className="flex gap-4 mb-12 md:mb-20">
            <Link to="/contact" className="btn-primary w-full sm:w-auto">Get a Demo</Link>
          </div>
          <Asset 
            src="/SiteGraphics/products/iotility-hero.jpg" 
            description="IoTility platform UI overview showing multiple module dashboards" 
            dimensions="1200x600" 
      ...
      <div className="bg-bg-secondary border-y border-border-subtle py-8 md:py-12">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <p className="text-text-secondary text-sm text-center md:text-right max-w-xl">
            Every IoTility product shares a single sign-on. Your team sees one unified dashboard — not five different systems.
          </p>
        </div>
      </div>
      ...
      <section className="section-padding bg-bg-secondary">
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <div className="mt-8 md:mt-0">
            <Asset 
              src="/SiteGraphics/products/iotility-ecosystem-diagram.jpg" 
