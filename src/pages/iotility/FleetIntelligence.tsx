  ...
  return (
    <div>
      ...
      <section className="section-padding bg-bg-primary">
        <div className="container mx-auto px-[60px]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <SectionHeader
                eyebrow="IOTILITY Â· FLEET INTELLIGENCE"
                h2="Fleet management built for your industry."
                subtext="Not generic GPS tracking. Fleet Intelligence wraps around your specific operation â€” with workflows, alerts, driver tools and reporting built for how your industry actually works."
              />
            ...
            <div className="relative rounded-2xl overflow-hidden border border-border-subtle">
              <Asset
                              src="/SiteGraphics/hero/fleet-1.mp4"
                              description=""
      ...
      <div className="bg-bg-secondary border-y border-border-subtle py-10 md:py-12">
        <div className="container mx-auto px-[60px] grid grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-10">
        ...
        <div className="container mx-auto px-[60px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <IndustryCard 
              ...
              body="Built for the Middle East rental model â€” multi-driver vehicles, contractual billing cycles, and insurance-grade trip reporting."
            />
            <IndustryCard 
      ...
      <section className="section-padding bg-bg-secondary">
        <div className="container mx-auto px-[60px]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 lg:gap-x-20 gap-y-6 max-w-4xl mx-auto">
            ...
            <CapabilityItem>AI dashcams (front, dual, 360Â°) with NVR/DVR</CapabilityItem>
        ...
        <div className="container mx-auto px-[60px] grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
           ...
           <div>
             <SectionHeader 
               ...
               subtext="We source, configure and install the right hardware for your fleet â€” Teltonika trackers, Howen AI dashcams, JimiIoT sensors and more."
             />
           </div>
