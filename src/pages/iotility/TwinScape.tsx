      ...
      <section className="section-padding bg-bg-primary">
        <div className="container mx-auto px-[60px]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <SectionHeader
                eyebrow="IOTILITY Â· TWINSCAPE"
                h2="Your building. Fully digital."
                subtext="TwinScape creates a complete digital twin of your facility â€” every floor, every room, every asset. See your building the way your BMS should have always shown it."
              />
            </div>
            ...
            <div className="relative rounded-2xl overflow-hidden border border-border-subtle">
                          <Asset
                                          src="/SiteGraphics/hero/twinscape.mp4"
                                          description=""
      ...
      <section className="section-padding bg-bg-primary">
        <div className="container mx-auto px-[60px]">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 text-left">
            ...
            <TwinUseCase icon="/SiteGraphics/icons/usecase-building.svg" title="Smart Buildings" body="Combine asset tracking with environmental monitoring â€” temperature, humidity, occupancy, energy load." />
          </div>
        </div>
      </section>
          ...
          <div className="mt-8 lg:mt-0">
           ...
           <div>
             <SectionHeader 
               ...
               subtext="A digital twin is a live, interactive model of your physical space. Every sensor, every asset, every environmental reading â€” mapped to the exact location in your building in real time."
             />
           </div>
