      ...
      <section className="section-padding bg-bg-primary">
        <div className="container mx-auto px-6">
          ...
          <div className="relative rounded-2xl overflow-hidden border border-border-subtle shadow-xl">
            <Asset 
              src="/SiteGraphics/products/twinscape-hero.jpg" 
              description="3D building digital twin interface showing floor plans with live asset overlays" 
              dimensions="1200x600" 
      ...
      <section className="section-padding bg-bg-secondary">
        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
           ...
           <div className="mt-8 lg:mt-0">
             <Asset 
               src="/SiteGraphics/products/twinscape-explainer.jpg" 
