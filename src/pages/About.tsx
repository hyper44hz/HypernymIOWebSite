        ...
        <div className="container mx-auto px-[60px]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12 md:mb-24">
           ...
           <div className="relative rounded-2xl overflow-hidden border border-border-subtle">
                                                <Asset
                                                                src="/SiteGraphics/hero/about.mov"
                                                                description=""
        ...
        <div className="container mx-auto px-[60px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-20">
             <div className="p-8 md:p-12 bg-bg-primary rounded-3xl border border-border-subtle">
               ...
               <p className="text-text-secondary text-[16px] md:text-lg leading-relaxed">"A world where every physical operation â€” every fleet, every facility, every asset â€” runs with the precision and intelligence of a software system."</p>
             </div>
             <div className="p-8 md:p-12 bg-bg-primary rounded-3xl border border-border-subtle">
        ...
        <div className="container mx-auto px-[60px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-16" >
            ...
            <CredentialItem 
              ...
              title="Microsoft Partner â€” Data & AI"
