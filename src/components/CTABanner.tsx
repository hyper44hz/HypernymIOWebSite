...
export const CTABanner: React.FC<{ h2?: string; subtext?: string; btnText?: string; secondaryLink?: string }> = ({ 
  ...
  subtext = "Book a 30-minute demo. We'll show you exactly how IoTility or Dataverse applies to your operation â€” no generic slides, no pressure.",
  btnText = "Book a Demo",
  secondaryLink = "Or explore the platform yourself â†’"
}) => {
  return (
